package app.revanced.patches.youtube.flyoutpanel.toggle
...
import app.revanced.patches.youtube.flyoutpanel.toggle.fingerprints.AdditionalSettingsConfigFingerprint
import app.revanced.patches.youtube.flyoutpanel.toggle.fingerprints.CinematicLightingFingerprint
import app.revanced.patches.youtube.flyoutpanel.toggle.fingerprints.PlaybackLoopInitFingerprint
import app.revanced.patches.youtube.flyoutpanel.toggle.fingerprints.PlaybackLoopOnClickListenerFingerprint
import app.revanced.patches.youtube.flyoutpanel.toggle.fingerprints.StableVolumeFingerprint
        ...
        fingerprint.resultOrThrow().let {
            it.mutableMethod.apply {
                ...
                if (referenceIndex > 0) {
                    ...
                    addInstructions(
                        referenceIndex + 2, """
                            invoke-static {v$insertRegister}, $FLYOUT_PANEL_CLASS_DESCRIPTOR->changeSwitchToggle(Z)Z
            ...
            it.mutableMethod.apply {
                ...
                addInstructionsWithLabels(
                    insertIndex, """
                        ...
                        invoke-static {v$freeRegisterC}, $FLYOUT_PANEL_CLASS_DESCRIPTOR->changeSwitchToggle(Z)Z
                        ...
                        invoke-static {v$freeRegisterE}, $FLYOUT_PANEL_CLASS_DESCRIPTOR->getToggleString(Ljava/lang/String;)Ljava/lang/String;
