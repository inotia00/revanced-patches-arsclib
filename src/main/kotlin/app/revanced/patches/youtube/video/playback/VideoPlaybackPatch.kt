...
object VideoPlaybackPatch : BaseBytecodePatch(
    ...
    override fun execute(context: BytecodeContext) {
        ...
        VideoInformationPatch.hookBackgroundPlay("$INTEGRATIONS_VIDEO_QUALITY_CLASS_DESCRIPTOR->newVideoStarted(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JZ)V")
