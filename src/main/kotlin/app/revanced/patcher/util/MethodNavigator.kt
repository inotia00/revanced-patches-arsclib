...
class MethodNavigator internal constructor(
    private val context: BytecodeContext,
     ...
     */
    fun stop() =
        context.classes.findClassProxied(matchesCurrentMethodReferenceDefiningClass)!!.mutableClass.firstMethodBySignature
                as MutableMethod
     ...
     */
    fun original(): Method = context.classes.first(matchesCurrentMethodReferenceDefiningClass).firstMethodBySignature
